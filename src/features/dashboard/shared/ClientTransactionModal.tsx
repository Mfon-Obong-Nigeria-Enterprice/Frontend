...
const ClientTransactionModal = () => {
  ...
  const getClientBalance = () => {
    return selectedTransaction?.client?.balance ?? 0;
  };
  ...
  ${(() => {
    const balance = getClientBalance();
    return balance < 0
          ...
          >
            ...
            <div>
              <p className={`font-bold text-base`}>
                {formatCurrency(getClientBalance())}
              </p>
              <div
                className={
                  getClientBalance() < 0
                    ? "bg-[#FFE7A4] py-2 px-2.5 rounded mt-1"
                    : ""
                }
              >
              ...
              <div className="flex justify-between border-b bordet-[#d9d9d9] pb-3">
                ...
                <div className="">
                  {selectedTransaction.client !== null && (
                    ...
                    >
                      {getClientBalance() < 0 ? "-" : ""}₦
                      {Math.abs(getClientBalance()).toLocaleString(undefined, {
                      ...
                      <div>
                        <p className="font-medium text-[#444444] text-[13px]">
                          ...
                          <span className="font-normal">
                            ₦
                            {(selectedTransaction?.total ?? 0).toLocaleString()}
                          </span>
                        </p>
                        <p className="font-medium text-[#444444] text-[13px]">
                          Method:{" "}
