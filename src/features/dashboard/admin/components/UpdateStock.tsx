            ...
            <div className="space-y-4 p-4 border-b">
              <div className="flex flex-col md:flex-row md:items-center md:gap-6 space-y-4 md:space-y-0">
                ...
                <div className="flex flex-col md:flex-row md:items-center md:gap-4 w-full md:w-auto">
                  <div className="flex items-center gap-2 w-full"> {/* Added w-full for stacking */}
                    <Label className="whitespace-nowrap">Set all selected to:</Label> 
                    <Input
                      type="number"
                  ...
                  <div key={product.id} className="border rounded-lg p-4">
                    ...
                    <div className="flex flex-col md:flex-row justify-between gap-6">
                      ...
                      <div className="flex flex-col gap-2">
                        ...
                        <div className="flex gap-4 flex-wrap mt-2"> {/* Added mt-2 for spacing */}
                          <div>
                        ...
                        <span className="text-sm block text-[#7D7D7D] ml-6 mt-2">Unit Price</span> {/* Added mt-2 */}
                      ...
                      <div className="w-full md:max-w-xs space-y-2 text-[#7D7D7D] pt-4 md:pt-10"> {/* Adjusted pt for mobile */}
