...
export const PriceUpdateTableSection: React.FC<PriceUpdateTableSectionProps> = ({
  ...
  return (
    <div className="space-y-4 p-4 bg-white rounded-lg shadow-md">
      <h2 className="text-xl font-semibold text-gray-800">Price Update Management</h2>
      ...
      <div className="md:hidden space-y-3">
        {products.map((product) => {
          ...
          return (
            <div key={product._id} className="border border-[#D9D9D9] rounded-lg p-3 bg-white">
              <div className="flex justify-between items-start mb-3">
                <h3 className="font-medium text-gray-800">{product.name || 'Unnamed Product'}</h3>
              ...
              <div className="grid grid-cols-2 gap-3 mb-3">
                <div>
                  ...
                  <p className="text-gray-600">₦{(product.unitPrice || 0).toLocaleString()}</p>
                </div>
                <div>
