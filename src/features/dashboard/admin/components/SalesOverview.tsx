  ...
  return (
    <div className="bg-white rounded-xl px-4 sm:px-8 py-6 font-Inter">
      <Tabs defaultValue="daily">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-[auto_1fr] items-center gap-4 lg:gap-0 mb-6">
          <TabsList className="bg-transparent p-0 justify-start">
            <p className="text-base sm:text-[16px] font-medium text-[var(--cl-text-dark)] whitespace-nowrap">
              Sales overview
            </p>
          </TabsList>

          <TabsList className="bg-transparent justify-start lg:justify-end w-full">
            <TabsTrigger
              value="daily"
              className="bg-transparent data-[state=active]:[&_span]:bg-[#D8E5FE] data-[state=active]:[&_span]:text-[#3D80FF]"
            >
              {/* Added justify-center here */}
              <span className="inline-flex items-center justify-center h-full w-full px-3 md:px-6 text-[var(--cl-text-gray)] text-[0.875rem] rounded">
                Daily
              </span>
            </TabsTrigger>
            <TabsTrigger
