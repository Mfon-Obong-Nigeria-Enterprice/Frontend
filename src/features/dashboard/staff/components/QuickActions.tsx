...
import { BsBoxSeam, BsCashStack } from "react-icons/bs";
  ...
  <div className="grid grid-cols-4 gap-10 min-h-[6.25rem]">
    ...
    <Link
      ...
      className="flex flex-col justify-center items-center gap-1 
                 bg-radial from-[#176639] to-[#239955] 
                 text-white rounded-[0.625rem] p-4"
    >
    ...
    <Link
      ...
      className="flex flex-col justify-center items-center gap-1 
                 ...
                 text-white rounded-[0.625rem] p-4"
    >
      <div className="flex gap-1 items-center"> <BsCashStack />
    ...
    <Link
      to="/staff/dashboard/s-clients"
      className="flex flex-col justify-center items-center gap-1 
                 bg-radial from-[#215AC8] to-[#2F6DE3] 
                 text-white rounded-[0.625rem] p-4"
    >
      <div className="flex gap-1 items-center">
        <IoPerson />
