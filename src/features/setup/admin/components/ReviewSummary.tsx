...
const ReviewSummary = ({
  ...
  return (
    <div className="bg-[#F5F5F5] rounded-[0.625rem] p-6">
      <h5 className="text-[var(--cl-text-dark)] font-normal text-lg font-Inter">
        {summaryHeading}
      ...
      <div className="flex flex-col gap-1 border-t border-[#D9D9D9] mt-3 pt-3">
        <div className="flex items-center justify-between">
          <p className="text-[var(--cl-secondary)]">{summaryName}</p>
          <p className="text-[#333333]">{nameVal}</p>
        </div>
        <div className="flex items-center justify-between">
          <p className="text-[var(--cl-secondary)]">{phoneOrEstimate}</p>
          <p className="text-[#333333]">{phoneOrEstimateValue}</p>
        </div>

        <div className="flex items-center justify-between">
          <p className="text-[var(--cl-secondary)]">{address}</p>
