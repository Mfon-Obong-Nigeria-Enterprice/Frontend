...
interface SettingsState {
  ...
  saveSettings: (mutation: UseMutationResult<Settings, Error, UpdateSettingsPayload>) => Promise<void>;
...
export const useSettingsStore = create<SettingsState>((set, get) => ({
  ...
  setSetting: (key, value) => {
    set((state) => {
      ...
      const hasChanges = JSON.stringify(newSettings) !== JSON.stringify(state._originalSettings);
